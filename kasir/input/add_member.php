...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview menu-open active">
                                ...
                                <li class="nav-item">
                                    <a href="add_member.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Registrasi</p>
                                    </a>
                                </li>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 d-flex">
                            <h1 class="m-0" style="position:absolute; left:40%">Registrasi Pelanggan</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form action="../proses/proses_registrasi.php" method="POST" style="width:78%; margin-left:20%; margin-top:20px;">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="telpon" pattern="" required>
            <small class="form-text text-muted">Harap masukkan nomor telpon yang valid (10-12 digit).</small>
        </div>
